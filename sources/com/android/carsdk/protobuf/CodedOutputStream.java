...
public abstract class CodedOutputStream extends ByteOutput {
    ...
    public static int computeUInt64SizeNoTag(long value) {
        if (((-128) & value) == ARRAY_BASE_OFFSET) {
            return 1;
        }
        if (value < ARRAY_BASE_OFFSET) {
            return 10;
        }
        int n = 2;
        if (((-34359738368L) & value) != ARRAY_BASE_OFFSET) {
            n = 2 + 4;
            value >>>= 28;
        }
        if (((-2097152) & value) != ARRAY_BASE_OFFSET) {
            n += 2;
            value >>>= 14;
        }
        if (((-16384) & value) != ARRAY_BASE_OFFSET) {
            return n + 1;
        }
        return n;
    }
    ...
    public static class ArrayEncoder extends CodedOutputStream {
        ...
        public final void writeUInt64NoTag(long value) throws IOException {
            if (CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS && spaceLeft() >= 10) {
                long pos = CodedOutputStream.ARRAY_BASE_OFFSET + this.position;
                while ((value & (-128)) != CodedOutputStream.ARRAY_BASE_OFFSET) {
    ...
    public static final class NioEncoder extends CodedOutputStream {
        ...
        public void writeUInt64NoTag(long value) throws IOException {
            while (((-128) & value) != CodedOutputStream.ARRAY_BASE_OFFSET) {
                try {
    ...
    public static abstract class AbstractBufferedEncoder extends CodedOutputStream {
        ...
        final void bufferUInt64NoTag(long value) {
            ...
            if (z) {
                ...
                long value2 = value;
                long pos = originalPos;
                for (long j = CodedOutputStream.ARRAY_BASE_OFFSET; (value2 & (-128)) != j; j = CodedOutputStream.ARRAY_BASE_OFFSET) {
            ...
            long value3 = value;
            while ((value3 & (-128)) != CodedOutputStream.ARRAY_BASE_OFFSET) {
                byte[] bArr = this.buffer;
                int i = this.position;
                this.position = i + 1;
