...
public abstract class SingleMessageHandler<EventType> implements Handler.Callback {
    ...
    private String getListString(List<EventType> events) {
        ...
        builder.append((String) events.stream().map(new Function() { // from class: com.android.car.internal.-$$Lambda$SingleMessageHandler$JsVbJ5mpbRjwJuW_A3bDJMqYpF0
    ...
    public void sendEvents(List<EventType> events) {
        ...
        this.mHandler.sendMessage(this.mHandler.obtainMessage(this.mHandledMessageWhat, data));
        if (!Build.IS_USER) {
