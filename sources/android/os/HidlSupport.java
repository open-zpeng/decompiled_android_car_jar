...
public class HidlSupport {
    ...
    public static boolean deepEquals(Object lft, Object rgt) {
        ...
        if (lftClazz.isArray()) {
            ...
            if (lftArray.length == rgtArray.length && IntStream.range(0, lftArray.length).allMatch(new IntPredicate() { // from class: android.os.-$$Lambda$HidlSupport$4ktYtLCfMafhYI23iSXUQOH_hxo
            ...
            return rgtList.stream().allMatch(new Predicate() { // from class: android.os.-$$Lambda$HidlSupport$oV2DlGQSAfcavBj7TK20nYhwS0U
    ...
    public static final class Mutable<E> {
        ...
        public synchronized Mutable() {
            this.value = null;
        }

        public synchronized Mutable(E value) {
            this.value = value;
        }
    }
    ...
    public static int deepHashCode(Object o) {
        ...
        if (clazz.isArray()) {
            ...
            return Arrays.hashCode(Arrays.stream((Object[]) o).mapToInt(new ToIntFunction() { // from class: android.os.-$$Lambda$HidlSupport$GHxmwrIWiKN83tl6aMQt_nV5hiw
            ...
            return Arrays.hashCode(((List) o).stream().mapToInt(new ToIntFunction() { // from class: android.os.-$$Lambda$HidlSupport$CwwfmHPEvZaybUxpLzKdwrpQRfA
                @Override // java.util.function.ToIntFunction
                public final int applyAsInt(Object obj) {
                    int deepHashCode;
                    deepHashCode = HidlSupport.deepHashCode(obj);
    ...
    private static synchronized void throwErrorIfUnsupportedType(Object o) {
    ...
    private static synchronized int primitiveArrayHashCode(Object o) {
