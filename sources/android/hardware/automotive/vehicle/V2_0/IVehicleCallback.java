...
public interface IVehicleCallback extends IBase {
    ...
    static IVehicleCallback getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static IVehicleCallback getService(boolean retry) throws RemoteException {
    ...
    public static final class Proxy implements IVehicleCallback {
        ...
        @Override // android.hardware.automotive.vehicle.V2_0.IVehicleCallback, android.hidl.base.V1_0.IBase, android.os.IHwInterface
        ...
        @Override // android.hardware.automotive.vehicle.V2_0.IVehicleCallback, android.hidl.base.V1_0.IBase
    ...
    public static abstract class Stub extends HwBinder implements IVehicleCallback {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(IVehicleCallback.kInterfaceName, IBase.kInterfaceName));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                case 1:
                    ...
                    return;
                case 2:
                    int areaId = _hidl_flags & 1;
                    _hidl_index_0 = areaId != 0 ? 1 : 0;
                    if (_hidl_index_0 != 1) {
                        _hidl_reply.writeStatus(Integer.MIN_VALUE);
                        _hidl_reply.send();
                        return;
                ...
                case 3:
                    ...
                    int areaId2 = _hidl_request.readInt32();
                    onPropertySetError(errorCode, propId, areaId2);
                    return;
                case 256067662:
