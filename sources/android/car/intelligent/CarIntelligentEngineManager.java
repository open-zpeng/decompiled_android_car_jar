...
public final class CarIntelligentEngineManager implements CarManagerBase {
    ...
    private final List<CarDrivingSceneListener> mCarDrivingSceneListeners = new CopyOnWriteArrayList();
    private final List<CarWelcomeSceneListener> mCarWelcomeSceneListeners = new CopyOnWriteArrayList();
    private final Handler mMainHandler = new Handler(Looper.getMainLooper());
    private final CarWelcomeSceneListenerToService mCarWelcomeSceneListenerToService = new CarWelcomeSceneListenerToService(this);
    private final CarDrivingSceneListenerToService mCarDrivingSceneListenerToService = new CarDrivingSceneListenerToService(this);
    ...
    public void handleWelcomeSceneChanged(final CarSceneEvent event) {
        this.mMainHandler.post(new Runnable() { // from class: android.car.intelligent.-$$Lambda$CarIntelligentEngineManager$ov67k4jIjg0P1XFyDw2QX1W4tMo
            ...
            public final void run() {
                CarIntelligentEngineManager.this.dispatchEventToCarWelcomeSceneClients(event);
            }
        });
    }
    ...
    public void handleCarDrivingSceneChanged(final CarSceneEvent event) {
        this.mMainHandler.post(new Runnable() { // from class: android.car.intelligent.-$$Lambda$CarIntelligentEngineManager$SbBuKgyofaUkhPkZx-nxhoK9rjs
            @Override // java.lang.Runnable
            public final void run() {
                CarIntelligentEngineManager.this.dispatchEventToCarDrivingSceneClients(event);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void dispatchEventToCarWelcomeSceneClients(CarSceneEvent event) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void dispatchEventToCarDrivingSceneClients(CarSceneEvent event) {
