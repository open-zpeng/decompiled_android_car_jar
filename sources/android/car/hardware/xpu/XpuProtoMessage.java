...
public final class XpuProtoMessage {
    ...
    public static final class CNGPCityMapRequest extends GeneratedMessageLite<CNGPCityMapRequest, Builder> implements CNGPCityMapRequestOrBuilder {
            ...
            protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke method, Object arg0, Object arg1) {
                switch (method) {
                    ...
                    case VISIT:
                        ...
                        this.reqType_ = visitor.visitInt(this.reqType_ != 0, this.reqType_, other.reqType_ != 0, other.reqType_);
        ...
        public CityRequest getCity() {
            CityRequest cityRequest = this.city_;
            return cityRequest == null ? CityRequest.getDefaultInstance() : cityRequest;
        }
        ...
        public void mergeCity(CityRequest value) {
            CityRequest cityRequest = this.city_;
            if (cityRequest != null && cityRequest != CityRequest.getDefaultInstance()) {
    ...
    public static final class CNGPCityMapResponse extends GeneratedMessageLite<CNGPCityMapResponse, Builder> implements CNGPCityMapResponseOrBuilder {
        ...
        public static final class CityResponse extends GeneratedMessageLite<CityResponse, Builder> implements CityResponseOrBuilder {
            ...
            public void writeTo(CodedOutputStream output) throws IOException {
                ...
                int i2 = this.mapStatus_;
                if (i2 != 0) {
                    output.writeInt32(2, i2);
                }
                int i3 = this.mapProgress_;
                if (i3 != 0) {
            ...
            protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke method, Object arg0, Object arg1) {
                switch (method) {
                    ...
                    case VISIT:
                        ...
                        this.mapProgress_ = visitor.visitInt(this.mapProgress_ != 0, this.mapProgress_, other.mapProgress_ != 0, other.mapProgress_);
                        GeneratedMessageLite.MergeFromVisitor mergeFromVisitor = GeneratedMessageLite.MergeFromVisitor.INSTANCE;
                        return this;
                    case MERGE_FROM_STREAM:
                        CodedInputStream input = (CodedInputStream) arg0;
        ...
        protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke method, Object arg0, Object arg1) {
            switch (method) {
                ...
                case VISIT:
                    ...
                    this.cityCode_ = visitor.visitInt(this.cityCode_ != 0, this.cityCode_, other.cityCode_ != 0, other.cityCode_);
                    this.result_ = visitor.visitInt(this.result_ != 0, this.result_, other.result_ != 0, other.result_);
                    GeneratedMessageLite.MergeFromVisitor mergeFromVisitor = GeneratedMessageLite.MergeFromVisitor.INSTANCE;
                    return this;
                case MERGE_FROM_STREAM:
                    CodedInputStream input = (CodedInputStream) arg0;
    ...
    public static final class VehLocationInfoResp extends GeneratedMessageLite<VehLocationInfoResp, Builder> implements VehLocationInfoRespOrBuilder {
        ...
        private float xPULocatX_ = CarPropertyManager.SENSOR_RATE_ONCHANGE;
        private float xPULocatY_ = CarPropertyManager.SENSOR_RATE_ONCHANGE;
        private float xPULocatZ_ = CarPropertyManager.SENSOR_RATE_ONCHANGE;
        private float xPULocatTheta_ = CarPropertyManager.SENSOR_RATE_ONCHANGE;
        private float xPULocatS_ = CarPropertyManager.SENSOR_RATE_ONCHANGE;
        private float xPULocatRoll_ = CarPropertyManager.SENSOR_RATE_ONCHANGE;
        private float xPULocatPitch_ = CarPropertyManager.SENSOR_RATE_ONCHANGE;
        private float xPULocatCurSpd_ = CarPropertyManager.SENSOR_RATE_ONCHANGE;
        ...
        public void clearXPULocatX() {
            this.xPULocatX_ = CarPropertyManager.SENSOR_RATE_ONCHANGE;
        }
        ...
        public void clearXPULocatY() {
            this.xPULocatY_ = CarPropertyManager.SENSOR_RATE_ONCHANGE;
        }
        ...
        public void clearXPULocatZ() {
            this.xPULocatZ_ = CarPropertyManager.SENSOR_RATE_ONCHANGE;
        }
        ...
        public void clearXPULocatTheta() {
            this.xPULocatTheta_ = CarPropertyManager.SENSOR_RATE_ONCHANGE;
        }
        ...
        public void clearXPULocatS() {
            this.xPULocatS_ = CarPropertyManager.SENSOR_RATE_ONCHANGE;
        }
        ...
        public void clearXPULocatRoll() {
            this.xPULocatRoll_ = CarPropertyManager.SENSOR_RATE_ONCHANGE;
        }
        ...
        public void clearXPULocatPitch() {
            this.xPULocatPitch_ = CarPropertyManager.SENSOR_RATE_ONCHANGE;
        }
        ...
        public void clearXPULocatCurSpd() {
            this.xPULocatCurSpd_ = CarPropertyManager.SENSOR_RATE_ONCHANGE;
        }

        @Override // com.android.carsdk.protobuf.MessageLite
        public void writeTo(CodedOutputStream output) throws IOException {
            long j = this.xPUTimestamp_;
            if (j != 0) {
                output.writeUInt64(1, j);
            }
            float f = this.xPULocatX_;
            if (f != CarPropertyManager.SENSOR_RATE_ONCHANGE) {
                output.writeFloat(2, f);
            }
            float f2 = this.xPULocatY_;
            if (f2 != CarPropertyManager.SENSOR_RATE_ONCHANGE) {
                output.writeFloat(3, f2);
            }
            float f3 = this.xPULocatZ_;
            if (f3 != CarPropertyManager.SENSOR_RATE_ONCHANGE) {
                output.writeFloat(4, f3);
            }
            float f4 = this.xPULocatTheta_;
            if (f4 != CarPropertyManager.SENSOR_RATE_ONCHANGE) {
                output.writeFloat(5, f4);
            }
            float f5 = this.xPULocatS_;
            if (f5 != CarPropertyManager.SENSOR_RATE_ONCHANGE) {
                output.writeFloat(6, f5);
            }
            float f6 = this.xPULocatRoll_;
            if (f6 != CarPropertyManager.SENSOR_RATE_ONCHANGE) {
                output.writeFloat(7, f6);
            }
            float f7 = this.xPULocatPitch_;
            if (f7 != CarPropertyManager.SENSOR_RATE_ONCHANGE) {
                output.writeFloat(8, f7);
            }
            float f8 = this.xPULocatCurSpd_;
            if (f8 != CarPropertyManager.SENSOR_RATE_ONCHANGE) {
                output.writeFloat(9, f8);
            }
        }
        ...
        public int getSerializedSize() {
            ...
            long j = this.xPUTimestamp_;
            int size2 = j != 0 ? 0 + CodedOutputStream.computeUInt64Size(1, j) : 0;
            float f = this.xPULocatX_;
            if (f != CarPropertyManager.SENSOR_RATE_ONCHANGE) {
                size2 += CodedOutputStream.computeFloatSize(2, f);
            }
            float f2 = this.xPULocatY_;
            if (f2 != CarPropertyManager.SENSOR_RATE_ONCHANGE) {
                size2 += CodedOutputStream.computeFloatSize(3, f2);
            }
            float f3 = this.xPULocatZ_;
            if (f3 != CarPropertyManager.SENSOR_RATE_ONCHANGE) {
                size2 += CodedOutputStream.computeFloatSize(4, f3);
            }
            float f4 = this.xPULocatTheta_;
            if (f4 != CarPropertyManager.SENSOR_RATE_ONCHANGE) {
                size2 += CodedOutputStream.computeFloatSize(5, f4);
            }
            float f5 = this.xPULocatS_;
            if (f5 != CarPropertyManager.SENSOR_RATE_ONCHANGE) {
                size2 += CodedOutputStream.computeFloatSize(6, f5);
            }
            float f6 = this.xPULocatRoll_;
            if (f6 != CarPropertyManager.SENSOR_RATE_ONCHANGE) {
                size2 += CodedOutputStream.computeFloatSize(7, f6);
            }
            float f7 = this.xPULocatPitch_;
            if (f7 != CarPropertyManager.SENSOR_RATE_ONCHANGE) {
                size2 += CodedOutputStream.computeFloatSize(8, f7);
            }
            float f8 = this.xPULocatCurSpd_;
            if (f8 != CarPropertyManager.SENSOR_RATE_ONCHANGE) {
                size2 += CodedOutputStream.computeFloatSize(9, f8);
            }
            this.memoizedSerializedSize = size2;
            return size2;
        }
        ...
        protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke method, Object arg0, Object arg1) {
            switch (method) {
                ...
                case VISIT:
                    ...
                    this.xPULocatX_ = visitor.visitFloat(this.xPULocatX_ != CarPropertyManager.SENSOR_RATE_ONCHANGE, this.xPULocatX_, other.xPULocatX_ != CarPropertyManager.SENSOR_RATE_ONCHANGE, other.xPULocatX_);
                    this.xPULocatY_ = visitor.visitFloat(this.xPULocatY_ != CarPropertyManager.SENSOR_RATE_ONCHANGE, this.xPULocatY_, other.xPULocatY_ != CarPropertyManager.SENSOR_RATE_ONCHANGE, other.xPULocatY_);
                    this.xPULocatZ_ = visitor.visitFloat(this.xPULocatZ_ != CarPropertyManager.SENSOR_RATE_ONCHANGE, this.xPULocatZ_, other.xPULocatZ_ != CarPropertyManager.SENSOR_RATE_ONCHANGE, other.xPULocatZ_);
                    this.xPULocatTheta_ = visitor.visitFloat(this.xPULocatTheta_ != CarPropertyManager.SENSOR_RATE_ONCHANGE, this.xPULocatTheta_, other.xPULocatTheta_ != CarPropertyManager.SENSOR_RATE_ONCHANGE, other.xPULocatTheta_);
                    this.xPULocatS_ = visitor.visitFloat(this.xPULocatS_ != CarPropertyManager.SENSOR_RATE_ONCHANGE, this.xPULocatS_, other.xPULocatS_ != CarPropertyManager.SENSOR_RATE_ONCHANGE, other.xPULocatS_);
                    this.xPULocatRoll_ = visitor.visitFloat(this.xPULocatRoll_ != CarPropertyManager.SENSOR_RATE_ONCHANGE, this.xPULocatRoll_, other.xPULocatRoll_ != CarPropertyManager.SENSOR_RATE_ONCHANGE, other.xPULocatRoll_);
                    this.xPULocatPitch_ = visitor.visitFloat(this.xPULocatPitch_ != CarPropertyManager.SENSOR_RATE_ONCHANGE, this.xPULocatPitch_, other.xPULocatPitch_ != CarPropertyManager.SENSOR_RATE_ONCHANGE, other.xPULocatPitch_);
                    this.xPULocatCurSpd_ = visitor.visitFloat(this.xPULocatCurSpd_ != CarPropertyManager.SENSOR_RATE_ONCHANGE, this.xPULocatCurSpd_, other.xPULocatCurSpd_ != CarPropertyManager.SENSOR_RATE_ONCHANGE, other.xPULocatCurSpd_);
                    GeneratedMessageLite.MergeFromVisitor mergeFromVisitor = GeneratedMessageLite.MergeFromVisitor.INSTANCE;
                    return this;
                case MERGE_FROM_STREAM:
                    CodedInputStream input = (CodedInputStream) arg0;
    ...
    public static final class V2_Point extends GeneratedMessageLite<V2_Point, Builder> implements V2_PointOrBuilder {
        ...
        private float lat_ = CarPropertyManager.SENSOR_RATE_ONCHANGE;
        private float lon_ = CarPropertyManager.SENSOR_RATE_ONCHANGE;
        ...
        public void clearLat() {
            this.lat_ = CarPropertyManager.SENSOR_RATE_ONCHANGE;
        }
        ...
        public void clearLon() {
            this.lon_ = CarPropertyManager.SENSOR_RATE_ONCHANGE;
        }
        ...
        public int getSerializedSize() {
            ...
            float f = this.lat_;
            int size2 = f != CarPropertyManager.SENSOR_RATE_ONCHANGE ? 0 + CodedOutputStream.computeFloatSize(1, f) : 0;
            float f2 = this.lon_;
            if (f2 != CarPropertyManager.SENSOR_RATE_ONCHANGE) {
        ...
        protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke method, Object arg0, Object arg1) {
            switch (method) {
                ...
                case VISIT:
                    ...
                    this.lat_ = visitor.visitFloat(this.lat_ != CarPropertyManager.SENSOR_RATE_ONCHANGE, this.lat_, other.lat_ != CarPropertyManager.SENSOR_RATE_ONCHANGE, other.lat_);
                    this.lon_ = visitor.visitFloat(this.lon_ != CarPropertyManager.SENSOR_RATE_ONCHANGE, this.lon_, other.lon_ != CarPropertyManager.SENSOR_RATE_ONCHANGE, other.lon_);
                    GeneratedMessageLite.MergeFromVisitor mergeFromVisitor = GeneratedMessageLite.MergeFromVisitor.INSTANCE;
                    return this;
                case MERGE_FROM_STREAM:
                    CodedInputStream input = (CodedInputStream) arg0;
    ...
    public static final class HeightDiffData extends GeneratedMessageLite<HeightDiffData, Builder> implements HeightDiffDataOrBuilder {
        ...
        @Override // com.android.carsdk.protobuf.MessageLite
        public void writeTo(CodedOutputStream output) throws IOException {
            int i = this.distToLinkStart_;
            if (i != 0) {
                output.writeInt32(1, i);
            }
            int i2 = this.heightDiffDist_;
            if (i2 != 0) {
                output.writeInt32(2, i2);
            }
            int i3 = this.heightDiffStraight_;
            if (i3 != 0) {
                output.writeInt32(3, i3);
            }
            int i4 = this.heightDiffParellel_;
            if (i4 != 0) {
        ...
        protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke method, Object arg0, Object arg1) {
            switch (method) {
                ...
                case VISIT:
                    ...
                    this.heightDiffParellel_ = visitor.visitInt(this.heightDiffParellel_ != 0, this.heightDiffParellel_, other.heightDiffParellel_ != 0, other.heightDiffParellel_);
                    GeneratedMessageLite.MergeFromVisitor mergeFromVisitor = GeneratedMessageLite.MergeFromVisitor.INSTANCE;
                    return this;
                case MERGE_FROM_STREAM:
                    CodedInputStream input = (CodedInputStream) arg0;
    ...
    public static final class Link extends GeneratedMessageLite<Link, Builder> implements LinkOrBuilder {
        ...
        public HeightDiffData getHeightDiffData() {
            HeightDiffData heightDiffData = this.heightDiffData_;
            return heightDiffData == null ? HeightDiffData.getDefaultInstance() : heightDiffData;
        }
        ...
        public void mergeHeightDiffData(HeightDiffData value) {
            HeightDiffData heightDiffData = this.heightDiffData_;
            if (heightDiffData != null && heightDiffData != HeightDiffData.getDefaultInstance()) {
        ...
        public void writeTo(CodedOutputStream output) throws IOException {
            ...
            boolean z = this.isOverHead_;
            if (z) {
                output.writeBool(5, z);
            }
            boolean z2 = this.hasParallelRoad_;
            if (z2) {
                output.writeBool(6, z2);
            }
            int i4 = this.linkDirection_;
            if (i4 != 0) {
                output.writeInt32(7, i4);
            }
            int i5 = this.roadDirection_;
            if (i5 != 0) {
                output.writeInt32(8, i5);
            }
            int i6 = this.laneNum_;
            if (i6 != 0) {
            ...
            for (int i7 = 0; i7 < this.v2Points_.size(); i7++) {
                output.writeMessage(11, this.v2Points_.get(i7));
            }
        }
        ...
        public int getSerializedSize() {
            ...
            long j = this.id_;
            int size2 = j != 0 ? 0 + CodedOutputStream.computeInt64Size(1, j) : 0;
            int i = this.linkType_;
            if (i != 0) {
            ...
            int i2 = this.formwayType_;
            if (i2 != 0) {
                size2 += CodedOutputStream.computeInt32Size(3, i2);
            }
            int i3 = this.roadClass_;
            if (i3 != 0) {
                size2 += CodedOutputStream.computeInt32Size(4, i3);
            }
            boolean z = this.isOverHead_;
            if (z) {
            ...
            boolean z2 = this.hasParallelRoad_;
            if (z2) {
                size2 += CodedOutputStream.computeBoolSize(6, z2);
            }
            int i4 = this.linkDirection_;
            if (i4 != 0) {
                size2 += CodedOutputStream.computeInt32Size(7, i4);
            }
            int i5 = this.roadDirection_;
            if (i5 != 0) {
                size2 += CodedOutputStream.computeInt32Size(8, i5);
            }
            int i6 = this.laneNum_;
            if (i6 != 0) {
            ...
            for (int i7 = 0; i7 < this.v2Points_.size(); i7++) {
                size2 += CodedOutputStream.computeMessageSize(11, this.v2Points_.get(i7));
            }
            this.memoizedSerializedSize = size2;
            return size2;
        }
        ...
        protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke method, Object arg0, Object arg1) {
            switch (method) {
                ...
                case VISIT:
                    ...
                    boolean z = this.isOverHead_;
                    boolean z2 = other.isOverHead_;
                    this.isOverHead_ = visitor.visitBoolean(z, z, z2, z2);
                    boolean z3 = this.hasParallelRoad_;
                    boolean z4 = other.hasParallelRoad_;
                    this.hasParallelRoad_ = visitor.visitBoolean(z3, z3, z4, z4);
    ...
    public static final class Camera extends GeneratedMessageLite<Camera, Builder> implements CameraOrBuilder {
        ...
        public V2_Point getPosition() {
            V2_Point v2_Point = this.position_;
            return v2_Point == null ? V2_Point.getDefaultInstance() : v2_Point;
        }
        ...
        public void mergePosition(V2_Point value) {
            V2_Point v2_Point = this.position_;
            if (v2_Point != null && v2_Point != V2_Point.getDefaultInstance()) {
    ...
    public static final class ViaPointInfo extends GeneratedMessageLite<ViaPointInfo, Builder> implements ViaPointInfoOrBuilder {
        ...
        public V2_Point getProjective() {
            V2_Point v2_Point = this.projective_;
            return v2_Point == null ? V2_Point.getDefaultInstance() : v2_Point;
        }
        ...
        protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke method, Object arg0, Object arg1) {
            switch (method) {
                ...
                case VISIT:
                    ...
                    this.direction_ = visitor.visitInt(this.direction_ != 0, this.direction_, other.direction_ != 0, other.direction_);
                    GeneratedMessageLite.MergeFromVisitor mergeFromVisitor = GeneratedMessageLite.MergeFromVisitor.INSTANCE;
                    return this;
                case MERGE_FROM_STREAM:
                    CodedInputStream input = (CodedInputStream) arg0;
    ...
    public static final class Path extends GeneratedMessageLite<Path, Builder> implements PathOrBuilder {
        ...
        public int getSerializedSize() {
            ...
            int size2 = j != 0 ? 0 + CodedOutputStream.computeUInt64Size(1, j) : 0;
            for (int i = 0; i < this.segments_.size(); i++) {
                size2 += CodedOutputStream.computeMessageSize(2, this.segments_.get(i));
            }
            for (int i2 = 0; i2 < this.trafficLights_.size(); i2++) {
    ...
    public static final class NaviRoutingInfo extends GeneratedMessageLite<NaviRoutingInfo, Builder> implements NaviRoutingInfoOrBuilder {
        ...
        public int getSerializedSize() {
            ...
            long j = this.navigationId_;
            if (j != 0) {
                size2 += CodedOutputStream.computeUInt64Size(2, j);
            }
            for (int i = 0; i < this.v2Points_.size(); i++) {
    ...
    public static final class NaviRoutingInfoV2 extends GeneratedMessageLite<NaviRoutingInfoV2, Builder> implements NaviRoutingInfoV2OrBuilder {
        ...
        private int navigationStatus_ = 0;
        private long navigationId_ = 0;
        private String sdkMajorVersion_ = "";
        private String sdkMinorVersion_ = "";
        ...
        public void mergePath(Path value) {
            Path path = this.path_;
            if (path != null && path != Path.getDefaultInstance()) {
        ...
        protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke method, Object arg0, Object arg1) {
            switch (method) {
                ...
                case VISIT:
                    ...
                    this.sdkMinorVersion_ = visitor.visitString(!this.sdkMinorVersion_.isEmpty(), this.sdkMinorVersion_, !other.sdkMinorVersion_.isEmpty(), other.sdkMinorVersion_);
