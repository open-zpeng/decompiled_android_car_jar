...
public class CarXpuManager extends CarEcuManager {
    ...
    public static final int ID_ICM_XPU_SR_HEART_BEAT = 554738281;
    ...
    private static final ArraySet<Integer> mXpuSharedMemoryPropertyIds = new ArraySet<>(Arrays.asList(561002507, 561002508, 561002509, 561002510, 561002511, 561002512, 561002514, 561002515, 561002527, 561002575, 561029735));
    ...
    public static XpuProtoMessage.CNGPCityMapResponse CNGPCityMapCtrlResponse(byte[] callback_data) throws Exception {
        try {
            ...
            Slog.e(TAG, "CNGPCityMapResponse parse error with exception" + e.toString());
            return null;
        }
    }
    ...
    public static XpuProtoMessage.CNGPCityMapFinNotify CNGPCityMapFinishNotify(byte[] callback_data) throws Exception {
        try {
            ...
            Slog.e(TAG, "CNGPCityMapFinNotify parse error with exception" + e.toString());
            return null;
        }
    }
    ...
    public static XpuProtoMessage.VehLocationInfoResp getVehLocationProto(byte[] data) throws Exception {
        try {
            ...
            Slog.e(TAG, "getVehLocationProto parse error with exception" + e);
            return null;
        }
    }
    ...
    public static XpuProtoMessage.NaviConfirm getNaviConfirmProto(byte[] data) throws Exception {
        try {
            ...
            Slog.e(TAG, "getNaviConfirmProto parse error with exception" + e);
            return null;
        }
    }
