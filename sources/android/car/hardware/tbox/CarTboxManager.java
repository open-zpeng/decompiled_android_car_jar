...
public final class CarTboxManager extends CarEcuManager {
    ...
    public static final int ID_CDU_TBOX_APN_TRAFFIC = 558960736;
    @SystemApi
    ...
    @SystemApi
    public static final int ID_TBOX_GUARD_TICK = 557846620;
    ...
    private final ICarTime mCarTimeService;
    ...
    public void setNitzTimezone(int type, String timezoneArea) throws Exception {
        if (type < 0) {
            throw new IllegalArgumentException("type must be larger than zero or equal to zero");
        }
        if (timezoneArea == null) {
            throw new IllegalArgumentException("timezoneArea can not be null");
        }
        this.mCarTimeService.setCarTimezone(type, timezoneArea);
    }
