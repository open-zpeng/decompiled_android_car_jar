...
public final class CarScuManager extends CarEcuManager {
    ...
    public static final int ID_SCU_DSM_CAMERA_SW = 557852414;
    public static final int ID_SCU_DSM_REMIND = 557852370;
    public static final int ID_SCU_DSM_SWITCH = 557852395;
    public static final int ID_SCU_DSM_TIRD_DISTRACTION = 557852415;
    ...
    public static final int RETURN_FROM_EXCEPTION = -1;
    ...
    public static final int SCU_START_VOICE_PARK_SIDE = 7;
    ...
    public static final int TIRD_DISTRACTION_OFF = 0;
    public static final int TIRD_DISTRACTION_ON = 1;
    ...
    public static final int XPU_ULC_REMIND_SW_HORN_ON = 2;
    public static final int XPU_ULC_REMIND_SW_LIGHT_ON = 1;
    public static final int XPU_ULC_REMIND_SW_OFF = 0;
    ...
    public int getDsmTiredDistractionStatus() {
        try {
            return this.mService.getDsmTiredDistractionStatus();
    ...
    public void setDsmTiredDistractionStatus(int onOff) {
        try {
            this.mService.setDsmTiredDistractionStatus(onOff);
        } catch (RemoteException | RuntimeException e) {
            Log.e(TAG, "throw RemoteException | RuntimeException e:" + e.getMessage());
        }
    }

    public int getDsmCameraStatus() {
        try {
            return this.mService.getDsmCameraStatus();
        } catch (RemoteException | RuntimeException e) {
            Log.e(TAG, "throw RemoteException | RuntimeException e:" + e.getMessage());
            return -1;
        }
    ...
    public void setDsmCameraStatus(int onOff) {
        try {
            this.mService.setDsmCameraStatus(onOff);
        } catch (RemoteException | RuntimeException e) {
            Log.e(TAG, "throw RemoteException | RuntimeException e:" + e.getMessage());
        }
    }
