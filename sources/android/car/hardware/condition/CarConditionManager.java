...
public class CarConditionManager extends CarManagerBase {
    ...
    public CarConditionManager(Car car, IBinder binder) {
        super(car);
    ...
    public void registerCondition(CarConditionInfo condition, CarConditionCallback listener) throws RemoteException {
        ...
        SparseArray<List<? extends Number>> limitsArray = condition.getLimitsArray();
