...
public final class CarIcmManager extends CarEcuManager {
    ...
    public static final int ID_ICM_FNGP_NAVI_PATH_RETAIN_TIME = 558896749;
    ...
    public static final int ID_ICM_LYRICS_MSG = 560993902;
    ...
    public CarIcmManager(IBinder service, IBinder vehicleService, IBinder sharedMemoryService, Context context, Handler handler) {
        super(service, context, handler, false, TAG);
        this.mIcmPropertyIds = new ArraySet<>(Arrays.asList(557848115, 557848116, 557848069, 557848096, 557848101, 557848103, 557848097, 557848118, 557848119, 560993821, 557848106, 557848098, 557848109, 557848100, 557848095, 559945269, 557913638, 560993795, 560993793, 560993800, 560993799, 560993807, 560993794, 557913644, 557913610, 560993803, 560993804, 560993805, 559945266, 559945265, 559945262, 559945264, 559945263, 557848104, 560993798, 557848107, 560993796, 557848078, 560993801, 554702352, 554702353, 554702354, 554702355, 554702356, 554702357, 554702358, 554702359, 554702360, 554702361, 554702362, 554702363, 554702364, 560993821, 560993793, 557848124, 557848122, 557848121, 557848120, 557848123, 557848125, 557848127, 557848126, 557848129, 557848130, 554702405, 557848135, 554702408, 557848137, 554702410, 557848140, 557848141, 557848139, 557848142, 557848094, 554702427, 554702428, 554702429, 554702431, 557848160, 554702433, 557848162, 557848163, 557848165, 554702438, 557913703, 557848169, 554702444, 560993902));
    ...
    private void sendData(int prop, byte[] data1, byte[] data2) throws Exception {
        try {
            ...
            if (pfd != null) {
                ...
                this.mSharedMemoryService.queueMemoryBuffer(prop, pfd, 4 + dataLength1 + dataLength2);
            } else {
    ...
    public int setFNgpNaviPathRetainTime(long second) {
        try {
            return this.mService.setFNgpNaviPathRetainTime(second);
        } catch (RemoteException | RuntimeException e) {
            e.printStackTrace();
            Slog.e(TAG, "setFNgpNaviPathRetainTime throw RemoteException | RuntimeException e " + e.getMessage());
            return 1;
        }
    }

    public void sendLyricsMessage(byte[] info) {
        try {
            this.mService.sendLyricsMessage(info);
        } catch (RemoteException | RuntimeException e) {
