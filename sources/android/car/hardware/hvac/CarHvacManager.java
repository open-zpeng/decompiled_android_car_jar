...
public final class CarHvacManager extends CarEcuManager {
    ...
    public void setHvacMachineStateSwitch(int enable) throws Exception {
        this.mService.setHvacMachineStateSwitch(enable);
    }

    public int getHvacMachineStateSwitch() throws Exception {
