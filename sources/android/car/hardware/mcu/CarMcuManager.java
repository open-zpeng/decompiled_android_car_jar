...
public final class CarMcuManager extends CarEcuManager {
    ...
    public static final int MCU_FAILED_POP_UP_ALARM_4G = 5;
    ...
    public String getMcuHardwareId() throws Exception {
        String mHardWareIdPro = SystemProperties.get(MCU_HARDWARE_ID_PROPERTY, CarBluetoothManager.BLUETOOTH_NO_PRIORITY_DEVICE);
        return mHardWareIdPro;
    }

    @SystemApi
    public String getVinCode() throws Exception {
        String mVinCodePro = SystemProperties.get(MCU_VIN_CODE_PROPERTY, CarBluetoothManager.BLUETOOTH_NO_PRIORITY_DEVICE);
        return mVinCodePro;
    }
