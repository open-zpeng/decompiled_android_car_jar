...
public final class CarBcmManager extends CarEcuManager {
    ...
    public static final int ETC_ACTIVE = 1;
    public static final int ETC_DISMANTLE_INVALID = 0;
    public static final int ETC_DISMANTLE_LIMIT = 2;
    public static final int ETC_DISMANTLE_VALID = 1;
    public static final int ETC_INACTIVE = 0;
    public static final int ETC_OFF = 0;
    public static final int ETC_ON = 1;
    public static final int ETC_SELFCHECK_DEFAULT = 0;
    public static final int ETC_SELFCHECK_FAILED = 2;
    public static final int ETC_SELFCHECK_SUCCESS = 1;
    public static final int ETC_SELFCHECK_UNFINISHED = 3;
    public static final int ETC_TOLLSTATION_IN = 1;
    public static final int ETC_TOLLSTATION_INIT = 0;
    public static final int ETC_TOLLSTATION_OUT = 2;
    ...
    public static final int ID_BCM_FLR_PARKINGLIGHT1_ST = 557915611;
    public static final int ID_BCM_FLR_PARKINGLIGHT2_ST = 557915612;
    ...
    public static final int ID_BCM_UNLOCK_HAZARD_LIGHT = 557850072;
    public static final int ID_BCM_UNLOCK_HORN = 557850073;
    ...
    public static final int ID_ETC_ACTIVE_ST = 557861378;
    public static final int ID_ETC_BLE_REQ = 557861382;
    public static final int ID_ETC_DISMANTLE_ST = 557861379;
    public static final int ID_ETC_SELFCHECK_ST = 557861380;
    public static final int ID_ETC_SW = 557861377;
    public static final int ID_ETC_TOLL_STATION_ST = 557861381;
    public static final int ID_IMS_AUTO_MODE_REQ = 557860872;
    public static final int ID_IMS_AUTO_VISION_SW = 557860866;
    public static final int ID_IMS_BRIGHT_LEVEL = 557860867;
    public static final int ID_IMS_HIGHSPEED_AUTO_VISION = 557860873;
    ...
    public static final int ID_PSDL_MOTOR_THERMAL_PROTECT = 557850070;
    public static final int ID_PSDL_SYSTEM_FAULT = 557850068;
    public static final int ID_PSDR_MOTOR_THERMAL_PROTECT = 557850071;
    public static final int ID_PSDR_SYSTEM_FAULT = 557850069;
    ...
    public static final int SLIDE_DOOR_FAULT = 1;
    ...
    public static final int SLIDE_DOOR_NORMAL = 0;
    public static final int SLIDE_DOOR_NOTPROTECT = 0;
    ...
    public static final int SLIDE_DOOR_PROTECTED = 1;
    ...
    public void setUnLockHazardLightSwitchStatus(int onOff) throws Exception {
        this.mService.setBcmUnLockHazardLightSwitchStatus(onOff);
    }

    public int getUnLockHazardLightSwitchStatus() throws Exception {
        return this.mService.getBcmUnLockHazardLightSwitchStatus();
    }
    ...
    public void setUnLockHornSwitchStatus(int onOff) throws Exception {
        this.mService.setBcmUnLockHornSwitchStatus(onOff);
    }

    public int getUnLockHornSwitchStatus() throws Exception {
        return this.mService.getBcmUnLockHornSwitchStatus();
    }
    ...
    public int getLeftSlideDoorFaultSt() throws Exception {
        return this.mService.getLeftSlideDoorFaultSt();
    }

    public int getRightSlideDoorFaultSt() throws Exception {
        return this.mService.getRightSlideDoorFaultSt();
    }

    public int getLeftSlideDoorThermalProtectSt() throws Exception {
        return this.mService.getLeftSlideDoorThermalProtectSt();
    }

    public int getRightSlideDoorThermalProtectSt() throws Exception {
        return this.mService.getRightSlideDoorThermalProtectSt();
    }
    ...
    public void setImsAutoModeReq(int mode) throws Exception {
        this.mService.setImsAutoModeReq(mode);
    }

    public void setImsHightSpeedAutoVisionSw(int onOff) throws RemoteException {
        this.mService.setImsHightSpeedAutoVisionSw(onOff);
    }

    public int getImsHightSpeedAutoVisionSt() throws RemoteException {
        return this.mService.getImsHightSpeedAutoVisionSt();
    }
    ...
    public void setEtcSwitch(int onOff) throws RemoteException {
        this.mService.setEtcSwitch(onOff);
    }

    public int getEtcSwitchState() throws RemoteException {
        return this.mService.getEtcSwitchState();
    }

    public int getEtcActiveState() throws RemoteException {
        return this.mService.getEtcActiveState();
    }

    public int getEtcDismantleState() throws RemoteException {
        return this.mService.getEtcDismantleState();
    }

    public int getEtcSelfCheckState() throws RemoteException {
        return this.mService.getEtcSelfCheckState();
    }

    public int getEtcTollStationState() throws RemoteException {
        return this.mService.getEtcTollStationState();
    }

    public void setEtcBluetoothReq(int onOff) throws RemoteException {
        this.mService.setEtcBluetoothReq(onOff);
    }

    public int[] getFrontLeftAndRightParkingLightGroup1Status() {
        int[] ret = {0, 0};
        try {
            return this.mService.getFrontLeftAndRightParkingLightGroup1Status();
        } catch (RemoteException | RuntimeException e) {
            Log.e(TAG, "getFrontLeftAndRightParkingLightGroup1Status throw RemoteException | RuntimeException e:" + e.getMessage());
            return ret;
        }
    }

    public int[] getFrontLeftAndRightParkingLightGroup2Status() {
        int[] ret = {0, 0};
        try {
            return this.mService.getFrontLeftAndRightParkingLightGroup2Status();
        } catch (RemoteException | RuntimeException e) {
            Log.e(TAG, "getFrontLeftAndRightParkingLightGroup2Status throw RemoteException | RuntimeException e:" + e.getMessage());
            return ret;
        }
    }
}
