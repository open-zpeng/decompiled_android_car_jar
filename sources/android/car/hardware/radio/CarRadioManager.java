...
public final class CarRadioManager extends CarEcuManager {
    ...
    public CarRadioManager(IBinder service, IBinder audioService, IBinder vehicleService, Context context, Handler handler) {
        ...
        this.mCarAudioManager = new CarAudioManager(audioService, context, handler);
    ...
    public void setPowerOnTunner() throws Exception {
        ...
        this.mHandler.post(new Runnable() { // from class: android.car.hardware.radio.-$$Lambda$CarRadioManager$NHeR6nJWg3mwiGypHQvcmoRZHSQ
            ...
            public final void run() {
                CarRadioManager.this.handleOnProgramInfoChangedEvent(null, true, true);
            }
        });
    }
    ...
    public void setPowerOffTunner() throws Exception {
        ...
        if (this.mIsTunerPowered) {
            ...
            this.mHandler.post(new Runnable() { // from class: android.car.hardware.radio.-$$Lambda$CarRadioManager$qmJ-6TXeSHpuSZTcG4G03BhEH0w
                @Override // java.lang.Runnable
                public final void run() {
                    CarRadioManager.this.handleOnProgramInfoChangedEvent(null, false, true);
                }
            });
        }
    }
    ...
    public void onProgramListUpdated() {
        ...
        this.mHandler.post(new Runnable() { // from class: android.car.hardware.radio.-$$Lambda$CarRadioManager$_BxlwfQfid5BMFDscEs54eQw080
            @Override // java.lang.Runnable
            public final void run() {
                CarRadioManager.lambda$onProgramListUpdated$2(CarRadioManager.this);
            }
        });
    }

    public static /* synthetic */ void lambda$onProgramListUpdated$2(CarRadioManager carRadioManager) {
        for (RadioManager.ProgramInfo info : carRadioManager.mProgramList.toList()) {
            carRadioManager.handleOnProgramInfoChangedEvent(info, true, false);
        }
    }
}
