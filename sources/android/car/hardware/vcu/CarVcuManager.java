...
public final class CarVcuManager extends CarEcuManager {
    ...
    public static final int DRIVING_MODE_STATUS_BOOST = 17;
    ...
    @Deprecated
    public static final int ENERGY_STATUS_RECOVERY_INTELLIGENT = 5;
    public static final int ENERGY_STATUS_RECOVERY_LOW = 1;
    public static final int ENERGY_STATUS_RECOVERY_MIDDLE = 2;
    public static final int ENERGY_STATUS_RECOVERY_XPEDAL = 4;
    ...
    public static final int ID_VCU_EXTERNAL_AIR_QUALITY = 557847201;
    ...
    public static final int ID_VCU_TRAFFIC_JAM_ST = 557847200;
    ...
    public static final int TRAFFIC_NOT_JAM = 0;
    ...
    public int getEnergyRegenMode() throws Exception {
        return this.mService.getVcuEnergyRecycleLevel();
    }
    ...
    public void setEnergyRegenMode(int mode) throws Exception {
        this.mService.setVcuEnergyRecycleLevel(mode);
    }
    ...
    public void setTrafficJamStatus(int jamStatus) throws Exception {
        this.mService.setTrafficJamStatus(jamStatus);
    }

    public void setExternalAirPm25(int pm25) throws Exception {
        this.mService.setExternalAirPm25(pm25);
    }
}
