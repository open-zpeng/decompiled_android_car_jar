...
public final class CarAvasManager extends CarEcuManager {
    ...
    public CarAvasManager(Car car, IBinder service, IBinder vehicleService, Context context, Handler handler) {
        super(car, service, false, TAG);
        this.mAvasPropertyIds = new ArraySet<>(Arrays.asList(557855233, 557855234, 557855235, 557855236, 557855237, 557855238, 557855239, 557855240, 557855241, 557855242, 557855243, 557855244, 557855245, 557855246, 557855247, 557855248, 557855249, 557855250, 557855251, 557855253, 557855255, 557855257));
