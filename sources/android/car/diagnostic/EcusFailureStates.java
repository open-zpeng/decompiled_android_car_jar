...
public class EcusFailureStates implements Parcelable {
    ...
    public EcusFailureStates() {
        ...
        int[] iArr = INT_VECTOR_DEFAULT_STATE;
        this.allTireTemperatureWarnings = iArr;
        this.allTirePerssureSensorsFailureStates = iArr;
        ...
        this.tcmMotorFailureStates = iArr;
        this.allMsmModulesFailureStates = iArr;
        ...
        this.hvacCompressorFailureStates = iArr;
        this.batteryPtcFailureStates = iArr;
    }
