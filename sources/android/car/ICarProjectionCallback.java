...
public interface ICarProjectionCallback extends IInterface {
    void onVoiceAssistantRequest(boolean z) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements ICarProjectionCallback {
        ...
        public static ICarProjectionCallback asInterface(IBinder obj) {
            ...
            if (iin != null && (iin instanceof ICarProjectionCallback)) {
                return (ICarProjectionCallback) iin;
            }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            onVoiceAssistantRequest(_arg0);
            return true;
        }

        /* loaded from: classes.dex */
        private static class Proxy implements ICarProjectionCallback {
