...
public final class AppBlockingPackageInfo implements Parcelable {
    ...
    public boolean isActivityCovered(String className) {
        ...
        for (String activityName : strArr) {
    ...
    public int hashCode() {
        int result = (1 * 31) + Arrays.hashCode(this.activities);
        int result2 = ((((((result * 31) + this.flags) * 31) + this.maxRevisionCode) * 31) + this.minRevisionCode) * 31;
        String str = this.packageName;
        return ((result2 + (str == null ? 0 : str.hashCode())) * 31) + Arrays.hashCode(this.signatures);
    }
